...
def main():
    ...
    print("Noise % = "+str(100*(sum(labels_DB==-1)/len(labels_DB==-1))))

    print("Number of Clusters (BEFORE Bisecting KMeans) = " + str(max_label_DB - min_label_DB + 1))
    ...
    print("Number of Clusters (AFTER Bisecting KMeans) = " + str(len(clust_list_DB_BKM)))
